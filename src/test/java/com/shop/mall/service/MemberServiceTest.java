...
class MemberServiceTest {
    ...
    public void 회원가입() throws Exception {
        //given
        Member2 member = new Member2("seanlee0701@naver.com","seanlee0701","서울특별시 장충단로 4길","1234",10000);
    ...
    public void 중복_이메일_회원_예외() throws Exception {
        //given
        Member2 member1 = new Member2("seanlee0701@naver.com","seanlee0701","서울특별시 장충단로 4길","1234",10000);

        Member2 member2 = new Member2("seanlee0701@naver.com","seanlee","서울특별시 장충단로 5길","4321",20000);

        //when
        memberService.register(member1);

        try {
            memberService.register(member2); //예외가 발생해야함
    ...
    public void 중복_닉네임_회원_예외() throws Exception {
        //given
        Member2 member1 = new Member2("seanlee0701@daum.com","seanlee0701","서울특별시 장충단로 4길","1234",10000);


        Member2 member2 = new Member2("seanlee0701@naver.com","seanlee0701","서울특별시 장충단로 6길","4321",20000);
    ...
    void 로그인_이메일_실패() throws Exception {
        ...
        Member2 member2 = new Member2("seanlee0701@naver.com","seanlee0701","서울특별시 장충단로 4길","1234",10000);

        //when
        try {
            memberService.login(member2); //예외가 발생해야함
    ...
    void 로그인_비밀번호_실패() throws Exception {
        ...
        Member2 member2 = new Member2("seanlee0701@daum.com","seanlee0701","서울특별시 장충단로 4길","4321",10000);
